...
def get_cloudcci_l3u_products():
    ...
    """
    return ['cc_mask_asc', 'cc_mask_desc', 
...
def get_cloudcci_l3c_products():
    ...
    """
    return ['cc_high', 'cc_low', 'cc_middle', 'cc_total',
            ...
            'lwp_uncertainty_std', 'npoints_macro', 'npoints_micro',
            'ref', 'ref_ice', 'ref_liq', 
            'ref_std', 'ref_std_ice', 'ref_std_liq',
            'ref_uncertainty', 'ref_uncertainty_ice', 
            'ref_uncertainty_liq', 'ref_uncertainty_std', 
            'ref_uncertainty_std_ice', 'ref_uncertainty_std_liq']
